...
def activate_game():
    ...
    player_label = tk.Label(system, text="BlackJack", font=('Times New Roman', 28, 'bold'))

    player_start = tk.Button(system, text="START", font=('Times New Roman', 12, 'bold'),
                             command=lambda: [system.withdraw(), game()])
